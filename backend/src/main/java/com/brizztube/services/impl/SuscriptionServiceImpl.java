...
import com.brizztube.response.SuscriptionResponse;
...
public class SuscriptionServiceImpl implements ISuscriptionService {
	...
	public ResponseEntity<SuscriptionResponseRest> unsubscribe(Long subscriberId, Long subscribedToId) {
		...
		try {
	        ...
	        Optional<Suscription> subscriptionOptional = suscriptionDao.findBySubscriberIdAndSubscribedToId(subscriberId, subscribedToId);
	...
	public ResponseEntity<SuscriptionResponseRest> getSuscriptionCountByUserId(Long userId) {
        ...
        try {
            ...
            response.getSuscriptionResponse().setSubscriberCount(subscriberCount);  // Añadir campo subscriberCount a SuscriptionResponse
